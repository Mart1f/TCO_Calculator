...
def make_example_truck_electric_fleet():
    ...
    return {
        ...
        "rv": {
            ...
            "year_purchase": 2025,
            "current_year": 2030,  # 10 years later
            "travel_measure": 300000.0,  # 80k km/year * 10 years
            "maintenance_cost": 36000.0,
            "minimum_fuel_consumption": 0.0, 
            "powertrain_model_year": 2024,
            "warranty": 450000.0,
            "type_warranty": 'km',
            "vehicle_number": 1,
            "consumption_real": 1.35,
            "C_bat_kwh": 500.0,
            "autonomy": 600.0,
            "E_annual_kwh":81000.0,
            "DoD":0.8,
            "S_slow":0.7,
            "S_fast":0.25,
            "S_ultra":0.05
...
def make_example_truck_diesel():
    ...
    return {
        ...
        "rv": {
            ...
            "type_energy": "DIESEL",
            "registration_country": "France",
            "purchase_cost": 60800.0,
            "year_purchase": 2025,
            "current_year": 2030,
            "travel_measure": 600000.0,
